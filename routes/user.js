...
const {register,login, logout, updatePassword, updateProfile, deleteMyProfile, myProfile, getUserProfile, getAllUsers, forgotPassword, resetpassword,getMyPosts,getUserPosts} = require('../controllers/user');
